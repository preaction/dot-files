...
require('lazy').setup({
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>l'] = {
          ...
          f = { "<cmd>lua require 'conform'.format { async = true, lsp_fallback = true }<cr>", '[F]ormat buffer' },
      ...
      local servers = {
        ...
        eslint = {
          ...
          on_attach = function(client, _)
            ...
            -- Make eslint the only formatter when it is available
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      -- vim.api.nvim_set_hl(0, 'WinBarNC', { link = 'EndOfBuffer' })
    end,
  },
